...
3. The JAR will be in `build/libs/easyhomes.jar`.

## Requirements

- **Server**: PaperMC 1.8.8 or higher.
- **Java**: 8 or higher.
- **Dependencies**: None (uses Paper API).

## Compatibility

- Tested on Paper 1.8.8 to 1.21.3.
- Should work on Spigot/Bukkit with Paper API.
...
If you have issues or questions, open an issue on GitHub or contact the maintainer.
